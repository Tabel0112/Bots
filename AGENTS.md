...
ARGUS + Ghost API remains partly in planning/research. On 2026-09-12 the user explicitly authorized implementing the DOM browser worker; its actual usage and limitations are in [Agents/browser_worker/README.md](Agents/browser_worker/README.md). The older synthetic implementation is provisional. Confirmed workstream assignments and tasks are in [TEAM.md](docs/ai/TEAM.md). Backlogs and implementation examples are context, not a request to resume unrelated coding.
