...
Ghost-specific documents, demo code, and future Ghost modules live in `ghostapi/`. B owns Ghost semantics. A owns browser mechanics. C owns ARGUS orchestration, shared contracts, database integration, and API delivery. D owns the dashboard, controlled site, and release evaluation.
