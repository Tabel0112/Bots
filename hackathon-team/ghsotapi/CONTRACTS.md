...
This is the authoritative location for the workflow schema and Ghost function interface extracted from the [shared contract](../CONTRACTS.md). Request, browser, result, error, and frontend contracts remain there. Field names and contract version are unchanged by this file move.
